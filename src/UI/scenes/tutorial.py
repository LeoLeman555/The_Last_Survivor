...
class Tutorial:
    ...
    def draw_shop(self, screen, step):
        if step <= 1:
            text = self.font.render(
                "Click here to buy weapons or extras", True, (255, 255, 255)
            )
            text_rect = text.get_rect()
            ...
            text = self.font.render(
                "Or here to unlock the power ups", True, (255, 255, 255)
            )
            text_rect = text.get_rect()
            ...
            text_rect = text.get_rect()
            text_rect.topleft = (170, 15)
            screen.blit(text, text_rect)
            pygame.draw.line(screen, (255, 255, 255), (165, 25), (150, 27))
    ...
    def draw_options(self, screen):
        ...
        pygame.draw.line(
            screen,
            (255, 255, 255),
            (text_rect.topleft[0] - 5, text_rect.topleft[1] + 12),
            (350, 150),
        )
